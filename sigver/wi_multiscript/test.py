...
def main(args):
   ...
   # print('Loading svm results from ')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-path', default='/Volumes/K/PhD/code/k_contrastive_sigver/models/signet_synth/model.pth')
    parser.add_argument('--data-path', default='/Volumes/K/PhD/database/preprocessed/mcyt.npz')
    parser.add_argument('--save-path', default='/Volumes/K/PhD/code/k_contrastive_sigver/')
    parser.add_argument('--input-size', nargs=2, default=(150, 220))

    parser.add_argument('--exp-users', type=int, nargs=2, default=(0, 40))
    parser.add_argument('--dev-users', type=int, nargs=2, default=(40, 74)) 
    
    parser.add_argument('--gen-for-train', type=int, default=10)
    parser.add_argument('--gen-for-test', type=int, default=5)
    parser.add_argument('--gen-for-ref', type=int, default=1)
